...
if __name__ == '__main__':
    ...
    augumenting_prompts = "Generate a variation of the following prompt while keeping the semantic meaning.\n"\
    ...
    if conf['use_wandb']:
        ...
        run = wandb.init(
            project=f"LLM4ISR_{conf['dataset']}_tune",
            config=conf,
        )
    ...
    for i in pbar:
        pbar.set_description("EPOCHS: " + str(i+1))
        prompt_candidate = []
